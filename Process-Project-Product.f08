program Process-Project-Product
      ...
      <p>
      <h1>Boolean Algebra Rules</h1>
      <p>
        
      </p>
      <img src=BA.jpg" alt="Boolean Algebra">
      ...
      <p>
          ...
          Such usable for detecting scams, it is better if they question than answer.
      <p>
      <h1>Database Analyzer</h1>
      <p>
        Based on SQL/NoSQL, data/performance/security/scalability/cost/relationships generally will vary. Excel should be used to support this.
        Enter in the ratings from 0.1 to 3.0 for how well they are functioning.
      </p>
  </body>
</html>
